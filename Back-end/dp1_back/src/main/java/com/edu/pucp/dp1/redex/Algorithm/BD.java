...
public class BD {
    ...
    public static void readAirports() {
        ...
        try (Scanner scanner = new Scanner(new File("Back-end/dp1_back/src/main/resources/input/datos.txt"))) {
            while (scanner.hasNextLine()) {
                String data = scanner.nextLine();
    ...
    public static void readShipments() {
        ...
        try (Scanner scanner = new Scanner(new File("Back-end/dp1_back/src/main/resources/input/pack/envios.txt"))) {
            while (scanner.hasNextLine()) {
                String data = scanner.nextLine();
                String[] split = data.split("-");

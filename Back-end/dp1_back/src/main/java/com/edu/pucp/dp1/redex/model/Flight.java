...
public class Flight {
    ...
    public Flight() {
        ...
        this.id = ++increment; // Incrementar y asignar el ID automáticamente
    ...
    public void calcEstimatedTime() {
        this.estimated_time = arrival_date_time.getTime() - departure_date_time.getTime()
                + TimeZoneAirport.calc_difference(arrival_airport, departure_airport) * 60 * 1000;
    }
